...
export const metadata: Metadata = {
  title: "eTax Mobile",
  description: "eTax Mobile Application for Vietnamese Tax Management",
  generator: "v0.app",
  ...
  return (
    <html lang="vi">
      <head>
        ...
        {/* iOS splash (placeholder using existing icons). Replace with real device-sized images when có tài sản */}
