  ...
  return (
    <>
      ...
      >
        ...
        >
          <button onClick={onClose} className="absolute top-4 right-4 text-white hover:opacity-80 z-10">
            <X className="w-6 h-6" />
          </button>
          ...
          {/* Greeting Box */}
          <div 
            className="bg-[rgba(216,14,4,1)] text-white px-5 py-3 w-full text-left"
            style={{
              fontSize: "22px",
              fontWeight: 600,
              lineHeight: 1.3,
